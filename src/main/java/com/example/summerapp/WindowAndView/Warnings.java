...
public class Warnings {
  public static void warningJump(int i){
      switch (i){
       ...
       case 5 -> JOptionPane.showMessageDialog(null, "You are wrong on something, so we can't edit it... yes, i breath.");
       ...
       case 7 -> JOptionPane.showMessageDialog(null, "HEY I NEED MORE LETTERS, GIVE ME AT LEAST 8");
          default -> JOptionPane.showMessageDialog(null, "(i hope no one see this one... oh...)");
      }
  }
}
