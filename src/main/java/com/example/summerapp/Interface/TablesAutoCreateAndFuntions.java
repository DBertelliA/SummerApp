...
public interface TablesAutoCreateAndFuntions { //Too loong
    ...
    public String dataSearch(String titleName, List<String> valuesForSearch, TableView<ObservableList<String>> tableShower, TextFlow dialogText, ImageView assistent, String user);
